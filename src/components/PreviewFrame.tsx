...
// let previewFrameHasRun = false; // module-level guard (persists across mounts)
...
//   const toastShownRef = useRef(false);
//   const installStartedRef = useRef(false);
//   const localHasRunRef = useRef(false); // local guard for this instance

//   async function main() {
//     console.log('[PreviewFrame] main() starting');
//     if (!webContainer) {
//       console.error('[PreviewFrame] webContainer not available yet');
//       return;
//     }

//     // ensure we only spawn install once (defensive)
//     try {
//       const installProcess = await webContainer.spawn('npm', ['install']);
//       let outputLength = 0;
...
//     } catch (err) {
//       console.error('[PreviewFrame] main() error', err);
//       toast.error('Preview failed to start. Check console for details.');
//     }
//   }

//   // run main only once when webContainer becomes available
//   useEffect(() => {
//     console.log('[PreviewFrame] useEffect webContainer changed', {
//       webContainerDefined: !!webContainer,
//       previewFrameHasRun,
//       localHasRun: localHasRunRef.current,
//     });

//     if (!webContainer) return; // wait until webcontainer is provided

//     if (previewFrameHasRun || localHasRunRef.current) {
//       console.log('[PreviewFrame] main already ran - skipping');
//       return;
//     }

//     localHasRunRef.current = true;
//     previewFrameHasRun = true;
//     main();
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//   }, [webContainer]); // run when webContainer becomes available
